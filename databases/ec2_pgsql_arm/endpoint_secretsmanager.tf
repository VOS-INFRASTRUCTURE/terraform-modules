...
#
# Use case: EC2 retrieves pgsql passwords from Secrets Manager during startup
#
# How it works:
...
locals {
  ...
  # VPC ID from subnet
  secretsmanager_vpc_id = var.enable_secretsmanager_endpoint ? data.aws_subnet.pgsql_subnet.vpc_id : ""
