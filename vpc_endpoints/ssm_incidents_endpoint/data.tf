...
#          subnet IDs to configure the SSM Incidents VPC endpoint properly.
#
...
# Used to construct SSM Incidents endpoint service name
# Example: com.amazonaws.eu-west-2.ssm-incidents
