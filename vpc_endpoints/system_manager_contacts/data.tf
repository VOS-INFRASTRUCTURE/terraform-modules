...
#          subnet IDs to configure the SSM Contacts VPC endpoint properly.
#
...
# Used to construct SSM Contacts endpoint service name
# Example: com.amazonaws.eu-west-2.ssm-contacts
