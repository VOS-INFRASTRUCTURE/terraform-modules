...
resource "aws_iam_role" "ec2_arm_docker" {
...
resource "aws_iam_role_policy_attachment" "ssm_policy" {
  ...
  role       = aws_iam_role.ec2_arm_docker.name
...
resource "aws_iam_role_policy" "cloudwatch_access" {
  ...
  role  = aws_iam_role.ec2_arm_docker.id
...
resource "aws_iam_instance_profile" "ec2_arm_docker" {
